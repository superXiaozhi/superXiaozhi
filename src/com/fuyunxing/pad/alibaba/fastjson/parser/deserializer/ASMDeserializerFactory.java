...
import static com.fuyunxing.pad.alibaba.fastjson.util.ASMUtils.getDesc;
import static com.fuyunxing.pad.alibaba.fastjson.util.ASMUtils.getType;
...
import com.fuyunxing.pad.alibaba.fastjson.asm.ClassWriter;
import com.fuyunxing.pad.alibaba.fastjson.asm.FieldVisitor;
import com.fuyunxing.pad.alibaba.fastjson.asm.Label;
import com.fuyunxing.pad.alibaba.fastjson.asm.MethodVisitor;
import com.fuyunxing.pad.alibaba.fastjson.asm.Opcodes;
...
import com.fuyunxing.pad.alibaba.fastjson.parser.JSONScanner;
import com.fuyunxing.pad.alibaba.fastjson.parser.JSONToken;
import com.fuyunxing.pad.alibaba.fastjson.parser.ParserConfig;
import com.fuyunxing.pad.alibaba.fastjson.parser.SymbolTable;
import com.fuyunxing.pad.alibaba.fastjson.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
import com.fuyunxing.pad.alibaba.fastjson.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.fuyunxing.pad.alibaba.fastjson.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultExtJSONParser.class), "getConfig",
                           "()" + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.fuyunxing.pad.alibaba.fastjson.asm.Type.getType(getDesc(fieldInfo.getMethod().getParameterTypes()[0])));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
